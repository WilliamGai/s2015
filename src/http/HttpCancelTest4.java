...
public class HttpCancelTest4 {
	...
	private class MyHttpThread extends Thread {
		...
		public MyHttpThread(String url) {
			HttpCancelTest4.this.waitor = waitor;
			this.url = url;
		}
		...
		public void run() {
			try {
				...
				if (setCancled()) {
					HttpCancelTest4.this.result = result;
					LockSupport.unpark(HttpCancelTest4.this.waitor);
					return;
				}
